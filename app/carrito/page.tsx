...
export default function CarritoPage() {
  ...
  return (
    <main className="relative mx-auto min-h-[75vh] max-w-5xl overflow-hidden px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
      ...
      <h1 className="mt-3 text-4xl font-black sm:text-5xl"><span className="text-white">TU</span> <span className="bg-[linear-gradient(180deg,#fff9d6_0%,#ffe990_24%,#ffd64f_48%,#ffc21f_74%,#fff1a8_100%)] bg-clip-text text-transparent drop-shadow-[0_0_12px_rgba(255,213,76,.75)]">CARRITO</span></h1>
