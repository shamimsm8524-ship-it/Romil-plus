  ...
  return <main className="relative min-h-screen overflow-hidden bg-[#030308] px-3 py-5 text-white sm:px-5 sm:py-7 min-[700px]:px-6 min-[700px]:py-8 lg:py-12">
    ...
    <div className="relative z-10 mx-auto max-w-4xl">
      <div className="mb-5 text-center sm:mb-6 min-[700px]:mb-7">
        ...
        <h1 className="mt-3 text-[28px] font-black sm:text-3xl min-[700px]:mt-4 min-[700px]:text-4xl"><span className="text-white">MI</span> <span className="bg-[linear-gradient(180deg,#fff9d6_0%,#ffe990_24%,#ffd64f_48%,#ffc21f_74%,#fff1a8_100%)] bg-clip-text text-transparent drop-shadow-[0_0_12px_rgba(255,213,76,.75)]">PERFIL</span></h1>
