...
export default function CatalogoPage() {
  return (
    <main className="mx-auto min-h-[75vh] w-full max-w-[1240px] px-4 py-8 sm:px-6 min-[760px]:px-6 min-[760px]:py-6 xl:px-8">
      <section className="mx-auto w-full">
        ...
        <div className="hidden overflow-hidden rounded-2xl border border-white/10 bg-[#0a0a0a] min-[760px]:grid min-[760px]:grid-cols-3">
        ...
        <div className="mt-10 text-center min-[760px]:mt-7">
          <h1 className="text-3xl font-black tracking-tight sm:text-4xl min-[760px]:text-[26px] xl:text-[30px]">PRODUCTOS <span className="text-[#e3b64f]">DESTACADOS</span></h1>
          <div className="mx-auto mt-3 h-1 w-12 rounded-full bg-[#e3b64f] min-[760px]:mt-2"/>
        </div>

        <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 min-[760px]:mt-5 min-[760px]:grid-cols-4 min-[760px]:gap-4 xl:gap-5">
          {products.map((product) => <ProductCard key={product.id} product={product} />)}
        </div>

        <div className="mt-8 hidden overflow-hidden rounded-2xl border border-white/10 bg-[#0a0a0a] min-[760px]:grid min-[760px]:grid-cols-4">
